...
public class quiz3 extends AppCompatActivity {
    ...
    String CorrectResp = "Antarctique";
    String question = "Quel est le plus grand désert du monde ? "
            + "Les choix sont : Sahara. Gobi. Antarctique.";
    int score = 0;
            ...
            result -> {
                if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                    ...
                    if (matches != null && !matches.isEmpty()) {
                        ...
                        if (voiceText.contains("antarctique")) {
                            score += 1;
