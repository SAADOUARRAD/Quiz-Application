...
public class quiz5 extends AppCompatActivity {
    ...
    String CorrectResp = "365";
    String question = "Combien de jours dans une année ? "
            + "Les choix sont : 365. 364. 366.";
    int score = 0;
            ...
            result -> {
                if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                    ...
                    if (matches != null && !matches.isEmpty()) {
                        ...
                        if (voiceText.contains("365") ||
                                voiceText.contains("trois cent soixante cinq")) {
                            score += 1;
                            Toast.makeText(this, "✅ Bonne réponse!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(this, "❌ Mauvaise réponse! : " + CorrectResp, Toast.LENGTH_SHORT).show();
                        }
                        Intent i2 = new Intent(quiz5.this, Score.class);
